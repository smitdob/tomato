                  ...
                  <div className="row">
                    ...
                    <div className="item-detail-cart-action col-12 col-md-3 text-center">
                      <div className="quantity-buttons">
                        <Tooltip title='Decrese quantity'><span className='' style={{ fontSize: 24, cursor: "pointer" }} onClick={decreaseQty}>-</span></Tooltip>
                        <input type="text" className='itemdetail-input-counter' placeholder='1' onChange={onChange} value={qty} />
                        <Tooltip title='Increse quantity'><span className='' style={{ fontSize: 24, cursor: "pointer" }} onClick={increaseQty}>+</span></Tooltip>
                      </div>
