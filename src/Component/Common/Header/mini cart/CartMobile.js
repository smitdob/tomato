...
const CartMobile = () => {
    ...
    return (
        <>
            <Tooltip title='cart'>
                <a className='minicart-icon' data-bs-toggle="offcanvas" href="#offcanvasExampleMobile" role="button" aria-controls="offcanvasExample">
                    <Badge badgeContent={getdata.length} color="primary" className='cur-po'>
                        <LocalMallOutlinedIcon className='cur-po' />
                    </Badge>
                </a>
            </Tooltip>
            <div className="offcanvas offcanvas-end offcanvas-width" tabIndex="-1" id="offcanvasExampleMobile" aria-labelledby="offcanvasExampleLabel">
                <div className="offcanvas-header">
                    <h5 className="offcanvas-title m-0" id="offcanvasExampleLabel">Cart</h5>
                                                ...
                                                <div key={e.Id}>
                                                    <div className='cart-content-wrapper'>
                                                        ...
                                                        <div className="header-cart-content">
                                                            ...
                                                            {/* <p className='header-cart-content-price'> <span className='text different'> ₹ {e.info.price}</span> </p> */}
